...
class Notify(private val context: Context) {
    ...
    fun setImportance(importance: NotifyImportance): Notify {
        oreoImportance = when (importance) {
            NotifyImportance.MIN -> NotificationManager.IMPORTANCE_MIN
            NotifyImportance.LOW -> NotificationManager.IMPORTANCE_LOW
            NotifyImportance.HIGH -> NotificationManager.IMPORTANCE_HIGH
            NotifyImportance.MAX -> NotificationManager.IMPORTANCE_MAX
        }
        return this
    }
